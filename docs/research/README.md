...
| [fresh-corpus-blind-spot](fresh-corpus-blind-spot.md) | 2026-08 | Entity IDF and supersedes demotion both measured zero on the pinned 200 set for structural reasons: single-entity queries and a single-pass corpus; the benchmark cannot see accumulation defects, and a soak arm is proposed |
